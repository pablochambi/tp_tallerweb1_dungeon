...
public class SessionMonsterIDImpl implements SessionMonsterID, Serializable {
    ...
    @Override public Long getMonsterId() { return monsterId; }
    @Override public void setMonsterId(Long monsterId) { this.monsterId = monsterId; }
    @Override
    public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof SessionMonsterIDImpl)) return false;
